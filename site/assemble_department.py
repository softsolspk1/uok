...
with open('department_template.html', encoding='utf-8') as f:
    html = f.read()
...
with open('department-cs.html', 'w', encoding='utf-8') as f:
    f.write(html)

print(f"Assembled department-cs.html: {len(html)/1024:.1f} KB")
